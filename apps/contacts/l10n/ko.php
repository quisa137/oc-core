...
"Password" => "암호",
"Base DN" => "기본 DN",
"Enable LDAP Backend"=>"LDAP Backend 활성화",
"You have no contacts in your address book or your address book is disabled."=>"연락처가 없습니다. 또는 연락처 기능이 비활성화 되었습니다",
"Add a new contact or import existing contacts from a VCF file."=>
"VCF 파일을 통해 연락처를 입력해 주세요",
"New contact"=>"새로운 연락처",
"New group"=>"새 그룹"
);
