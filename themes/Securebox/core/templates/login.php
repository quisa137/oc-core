...
<form method="post" name="login">
	...
	<?php if (!empty($_['redirect_url'])) {
		...
		<p class="grouptop">
			...
			<img class="svg" src="<?php print_unescaped(image_path('', 'actions/user.png')); ?>" alt=""/>
		</p>
		...
		<p class="groupbottom">
			...
			<img class="svg" id="password-icon" src="<?php print_unescaped(image_path('', 'actions/password.png')); ?>" alt=""/>
		</p>
