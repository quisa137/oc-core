...
"Weak password" => "약한 암호",
"So-so password" => "어중간한 암호",
"Good password" => "조금 강력한 암호",
...
"The update was successful. Redirecting you to ownCloud now." => "업데이트가 성공하였습니다. NCDrive로 돌아갑니다.",
...
"This ownCloud instance is currently in single user mode." => "NCDrive 인스턴스가 현재 단일 사용자 모드로 동작 중입니다.",
...
"This ownCloud instance is currently being updated, which may take a while." => "NCDrive 인스턴스가 현재 업데이트 중입니다. 잠시만 기다려 주십시오.",
"Please reload this page after a short time to continue using ownCloud." => "잠시 후 페이지를 다시 불러온 다음 NCDrive를 사용해 주십시오."
);
