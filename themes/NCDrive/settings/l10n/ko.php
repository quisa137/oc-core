...
"You are accessing %s via HTTP. We strongly suggest you configure your server to require using HTTPS instead." => "NCDrive에 HTTP로 접근하고 있습니다. 서버에서 HTTPS를 사용하도록 설정하는 것을 추천합니다.",
...
"Forces the clients to connect to %s via an encrypted connection." => "클라이언트가 NCDrive에 연결할 때 암호화 연결을 강제로 사용합니다.",
"Please connect to your %s via HTTPS to enable or disable the SSL enforcement." => "SSL 강제 설정을 변경하려면 NCDrive에 HTTPS로 연결해야 합니다.",
...
"Less" => "가리기",
"Version" => "버전",
"Developed by the <a href=\"http://ownCloud.org/contact\" target=\"_blank\">ownCloud community</a>, the <a href=\"https://github.com/owncloud\" target=\"_blank\">source code</a> is licensed under the <a href=\"http://www.gnu.org/licenses/agpl-3.0.html\" target=\"_blank\"><abbr title=\"Affero General Public License\">AGPL</abbr></a>." => "<a href=\"http://ownCloud.org/contact\" target=\"_blank\">ownCloud community</a> 에 의해서 개발 되었습니다. <a href=\"https://github.com/owncloud\" target=\"_blank\">소스코드</a>는 <a href=\"http://www.gnu.org/licenses/agpl-3.0.html\" target=\"_blank\"><abbr title=\"Affero General Public Licence\">AGPL</abbr></a> 라이선스 아래 보호됩니다.",
"Developed by the NCSoft" => "NCSoft에 의해 개발되었습니다.",
"Add your App" => "내 앱 추가",
"More Apps" => "더 많은 앱",
"Select an App" => "앱 선택",
"Documentation:" => "문서",
"See application page at apps.owncloud.com" => "앱 페이지를 참고하십시오",
